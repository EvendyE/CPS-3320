...
Answer = ['hangman', 'variable','polymorphism', 'encapsulation', 'camelcase', 'object', 'class', 'inheritance', 'extend', 'function', 'overload', 'call', 'pass',
          'return', 'recursion', 'accessor', 'mutator', 'argument', 'index', 'compiler', 'boolean', 'double', 'float', 'long', 'string', 'list', 'tuple',
          'dictionary', 'key', 'value', 'break', 'continue', 'elif', 'range', 'declare', 'initialize', 'extends', 'import', 'syntax', 'interpreter', 'idle', 'python', 'java', 'idle',
